...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/manage/building/{id}', [BuildingController::class, 'showByUniversity'])->name('buildingByUniversity');
        
        // Page Gedung (Building)
        Route::get('/manage/building', [BuildingController::class, 'index'])->name('building');
        Route::get('/manage/gedung/create', [BuildingController::class, 'create'])->name('building.create');
        ...
        Route::delete('/manage/building/delete/{id}', [BuildingController::class, 'destroy'])->name('building.delete');
        Route::get('/manage/floor/{id}', [FloorController::class, 'showByBuilding'])->name('floorByBuilding');
